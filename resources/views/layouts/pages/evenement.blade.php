  ...
  <section class="section team-page">
    <div class="container">
      ...
      <div class="row">
        ...
        <!-- Formation 2 : Marketing Relationnel -->
        <div class="col-md-4 mb-4 text-center">
          <div class="gallery-item">
        ...
        <!-- Formation 3 : Leadership & Autonomie -->
        <div class="col-md-4 mb-4 text-center">
          <div class="gallery-item">
            <a href="{{ asset('assets/images/team/img16.jpg') }}" class="glightbox" data-gallery="formation3">
              <img src="{{ asset('assets/images/team/img20.jpg') }}" alt="Leadership & Autonomie Financière" class="img-fluid rounded shadow" style="height: 250px; object-fit: cover;">
              <div class="overlay"><i class="fa fa-search-plus"></i></div>
            </a>
          </div>
