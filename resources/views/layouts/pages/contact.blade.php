    ...
    <section class="section contact-info pb-0">
        <div class="container">
            ...
            <div class="row mt-4">
                <!-- Site Web -->
                <div class="col-12 col-sm-6 col-md-4 mb-4">
                    <div class="contact-block h-100 text-center">
                        <i class="icofont-web"></i>
                        <h5 style="color: #223a66; margin-top: 10px;">Notre site web</h5>
                        <a href="https://globalgplus.net/globalgplus" target="_blank" class="d-inline-block text-break"
                            style="color: #223a66; word-break: break-word;">
                            globalgplus.net/globalgplus
                        </a>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        ...
                        <h4 class="mb-5">
                            Vous avez une question, un besoin spécifique ou souhaitez simplement nous joindre ? Remplissez
                            le formulaire ci-dessou.
                        </h4>
                    </div>
                </div>
            </div>
